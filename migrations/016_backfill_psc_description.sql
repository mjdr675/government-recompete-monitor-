...
-- Use regexp_matches to extract the value safely without a full JSONB
-- cast, so malformed or NULL raw_json rows are silently skipped.

UPDATE contracts
SET psc_description = (regexp_matches(raw_json, '"psc_description"\s*:\s*"([^"]*)"'))[1]
